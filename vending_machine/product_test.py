...
class ProductTests(unittest.TestCase):
    ...
    def test_should_return_equals_when_same_name_and_price(self):
        self.assertTrue(TestsFixture.PRODUCT_1.__eq__(Product("Cola", 1)))

    def test_should_return_not_equal_when_different_price(self):
        self.assertFalse(TestsFixture.PRODUCT_1.__eq__(Product("Cola", 2)))

    def test_should_return_not_equal_when_different_name(self):
        self.assertFalse(TestsFixture.PRODUCT_1.__eq__(Product("Candy", 1)))
    ...
    def test_should_return_same_hash_for_same_object(self):
        self.assertEqual(TestsFixture.PRODUCT_1.__hash__(), Product("Cola", 1).__hash__())
